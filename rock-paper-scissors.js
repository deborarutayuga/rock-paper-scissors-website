let score = JSON.parse(localStorage.getItem('score')) || {
    ...
    function autoPlay(){// hoisting :to call a function before reading it
        if(!isAutoPlaying){
            //save the Id
            ...
            isAutoPlaying = false;//to stop

            document.querySelector('.js-auto-button').innerHTML = 'Auto playing';
    ...
    function resetMessage (){
        document.querySelector('.js-reset').innerHTML = `Are you sure you want to reset the score?
